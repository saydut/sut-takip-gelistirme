...
if (typeof window.ui === 'undefined') {
    ...
    window.ui = {
        ...
        showGirdilerLoadingSkeleton(gorunum) {
            ...
            for(let i=0; i<4; i++) {
                if (gorunum === 'liste') {
                    html += `<div class="p-4 border-b border-gray-100 animate-pulse flex justify-between">...</div>`;
                } else {
                    html += `<div class="bg-white p-4 rounded-xl border border-gray-200 animate-pulse h-32">...</div>`;
                }
            }
